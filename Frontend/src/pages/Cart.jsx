...
const Cart = () => {
  ...
  return (
    <div className='border-t border-gray-300 pt-14'>
      ...
      <div>
        {
          ...
          return(
            <div key={index} className='py-4 border-t bordr-b border-gray-300 text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
      ...
      <div className='flex justify-end mmy-20'>
